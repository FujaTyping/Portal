    ...
    <>
      <div className="absolute top-20 -mt-16 md:-mt-0 -ml-40 w-full rotate-[-0.4rad] text-red-500 font-bold text-5xl md:text-7xl">
        <Marquee direction="right" className="slide-in-left overflow-hidden">
          <p>FUJATYPING</p>
          <Sparkle size={50} className="mx-10" />
          <p>FJT</p>
          <Sparkle size={50} className="mx-10" />
          <p>SIRAPHOP</p>
          <Sparkle size={50} className="mx-10" />
          ...
          <div className="flex flex-col md:flex-row gap-6 place-content-between px-6 py-12 text-white border-t-4 border-red-900">
            <div>
              ...
              <p className="max-w-md mt-3">
                3D modeler, Web developer, and Roblox scripter, Anime lover and
                music vibe hunter
              </p>
            </div>
            <div
              id="MainLink"
              className={`${OS.className} flex flex-col w-full md:ml-6 md:flex-row items-center justify-center gap-5`}
            >
              <Link
              ...
              <Link
                href={"https://x.com/FujaTyping"}
                className="w-full flex items-center justify-center gap-2"
              >
                <Twitter size={18} /> Twitter
              </Link>
              <Link
                href={"mailto:contact@siraphop.me"}
                className="w-full flex items-center justify-center gap-2"
              >
                <Mail size={18} /> Mail
              </Link>
              <Link
                href={"https://www.linkedin.com/in/siraphop-sukchu/"}
                className="w-full flex items-center justify-center gap-2"
              >
